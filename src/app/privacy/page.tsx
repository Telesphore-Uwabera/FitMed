...
const policySections = [
  ...
  },
  {
    ...
    content: [
      { heading: "5.1 Access",              text: "You have the right to access the personal and health information we hold about you. Submit an access request to fixmed@gmail.com." },
      { heading: "5.2 Correction",          text: "You have the right to correct inaccurate personal information. Contact us at fixmed@gmail.com." },
        ...
        <div className="bg-slate-50 rounded-2xl p-7 border border-slate-200">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { label: "Privacy Contact",   value: "fixmed@gmail.com",  href: "mailto:fixmed@gmail.com" },
              { label: "General Enquiries", value: "fixmed@gmail.com",    href: "mailto:fixmed@gmail.com" },
