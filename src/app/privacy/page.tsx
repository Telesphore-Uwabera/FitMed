...
const securityPillars = [
  ...
  { icon: Eye,         title: "Minimal Data Disclosure",        color: "text-teal-600",    bg: "bg-teal-50",    border: "border-teal-100",    desc: "Employers see only certificate validity. Medical history stays private between patient and doctor at all times." },
  { icon: FileCheck,   title: "Full Audit Trail",               color: "text-violet-600",  bg: "bg-violet-50",  border: "border-violet-100",  desc: "Every certificate is fully traceable from patient submission through doctor review, decision, signature, and issuance." },
  { icon: Key,         title: "Role-Based Access Control",      color: "text-amber-600",   bg: "bg-amber-50",   border: "border-amber-100",   desc: "Patients, doctors, employers, and admins each see only what they are permitted to access. No over-sharing." },
          ...
          <div className="bg-white p-7">
            ...
            <div className="mt-10 space-y-5 border-t border-slate-100 pt-8">
              ...
              {[
                ...
                { heading: "6.3 Role-Based Access Control",      text: "Our platform enforces strict role-based access control (RBAC). Patients can access only their own data. Doctors can access only the patient data assigned to them for assessment. Employers can access only certificate validity information. Administrators have access only to data required for platform operation and compliance." },
                { heading: "6.4 Audit Logging",                  text: "Every action involving personal or health data is logged with a timestamp, user identifier, and action type. These audit logs are tamper-evident and retained for the period required by applicable law. They enable full traceability from patient submission through to certificate issuance." },
                { heading: "6.5 Doctor Credential Verification", text: "Before any doctor can access patient data or conduct assessments on FitMed, their professional licence number, specialty, and credentials are verified against official registries. Doctor performance is monitored on an ongoing basis, and access can be suspended immediately if concerns arise." },
