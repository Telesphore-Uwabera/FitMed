    ...
    <PageLayout title="Press" subtitle="Media resources and brand assets">
      <div className="space-y-10">
        ...
        <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-7">
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <div className="flex-1 p-5 bg-sky-50 rounded-2xl border border-sky-100">
              ...
              <a href="mailto:support@fitnessmed.rw" className="text-base font-bold text-sky-600 hover:underline flex items-center gap-2">
                <Mail className="w-4 h-4" /> support@fitnessmed.rw
              </a>
            </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-7">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              { label: "Brand Guidelines", file: "mailto:support@fitnessmed.rw" },
            ].map((asset) => (
              <a
                key={asset.label}
                href={asset.file}
        ...
        <div className="bg-slate-900 rounded-3xl p-8 text-center">
          ...
          <a href="mailto:support@fitnessmed.rw" className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-bold text-white btn-primary group">
